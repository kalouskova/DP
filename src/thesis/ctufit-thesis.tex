...
\ctufitkeywordsENG{motion artefact, electrocardiography, ECG classification, automatic artefact detection in ECG, biosignal processing, convolutional neural network, deep learning}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END FILL IN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
